...
clear = Button(window, text='CLEAR', fg='black', bg='light grey', command=clearAll, height=2, width=8)
clear.grid(row=2, column=4, padx=5, pady=5)

enter = Button(window, text='ENTER', fg='black', bg='light grey', height=2, width=8)
